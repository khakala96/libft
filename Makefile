...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/10/16 11:43:54 by khakala           #+#    #+#              #
#    Updated: 2019/10/30 12:52:15 by khakala          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c \
		ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memset.c ft_strcat.c ft_strchr.c \
		...
		ft_islower.c ft_isupper.c ft_print_list.c ft_print_list_content.c ft_intlength.c \

OBJ=ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o ft_isprint.o \
		ft_memchr.o ft_memcmp.o ft_memcpy.o ft_memccpy.o ft_memmove.o ft_memset.o ft_strcat.o ft_strchr.o \
		ft_strcmp.o ft_strcpy.o ft_strdup.o ft_strlcat.o ft_strclr.o ft_strlen.o ft_strncat.o ft_strncmp.o \
		ft_strncpy.o ft_strnstr.o ft_strrchr.o ft_strstr.o ft_tolower.o ft_toupper.o ft_memalloc.o \
        ft_memdel.o ft_strnew.o	ft_strdel.o ft_striter.o ft_striteri.o ft_strmap.o ft_strmapi.o	\
        ...
        ft_putnbr_fd.o ft_lstnew.o ft_lstdelone.o ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o \
		ft_islower.o ft_isupper.o ft_print_list.o ft_print_list_content.o ft_intlength.o \
